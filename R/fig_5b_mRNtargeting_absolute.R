...
C1_phageProbablity <- pbinom(subset(dataPooledC1, target == "fcl2")$r_ratio*dataPooledC1$totalExcludeIntergenics[1], dataPooledC1$totalExcludeIntergenics[1],0.5, lower.tail=TRUE)
C1_selfProbablity <- pbinom(subset(dataPooledC1, target == "b185")$r_ratio*dataPooledC1$totalExcludeIntergenics[2], dataPooledC1$totalExcludeIntergenics[2],0.5, lower.tail=FALSE)
C2_phageProbablity <- pbinom(subset(dataPooledC2, target == "fcl2")$r_ratio*dataPooledC2$totalExcludeIntergenics[1], dataPooledC2$totalExcludeIntergenics[1],0.5, lower.tail=FALSE)
C2_selfProbablity <- pbinom(subset(dataPooledC2, target == "b185")$r_ratio*dataPooledC2$totalExcludeIntergenics[2], dataPooledC2$totalExcludeIntergenics[2],0.5, lower.tail=TRUE)
...
#II-C plot
C1plot <- ggplot(dataReplicatesC1, aes(x=target, y=r_ratio, label = totalExcludeIntergenics)) +
  #  geom_label_repel(
  #    segment.size  = 0.2,
  ...
  labs(y = "Proportion of mRNA-targeting\nspacers (absolute count)", x = "II-C", size = 16) +
...
#VI-B plot
C2plot <- ggplot(dataReplicatesC2, aes(x=target, y=r_ratio, label = totalExcludeIntergenics)) +
  #  geom_label_repel(
  #    segment.size  = 0.2,
  #    segment.color = "grey50",
  #    alpha = 0.5,
...
mRNA_plot <- grid.arrange(C1plot, hist_C1, C2plot, hist_C2, nrow = 1, ncol = 4, widths=c(4,1,4,1))
ggsave(mRNA_plot, filename = "Fig5B.png", height = 5, width = 7)